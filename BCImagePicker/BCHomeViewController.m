...
- (void)viewDidLoad {
    ...
    self.searchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(0.0, CGRectGetMaxY(self.navigationController.navigationBar.frame), self.view.frame.size.width, 44.0)];
